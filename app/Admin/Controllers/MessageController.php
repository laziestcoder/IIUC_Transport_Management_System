...
class MessageController extends Controller
{
    ...
    public function grid()
    {
        return Admin::grid(MessageModel::class, function (Grid $grid) {
            ...
            // $grid->read_at('Seen')->display(function ($time) {
            //     return Carbon::parse($time)->format('d-m-y h:g A');
            // });
            $grid->created_at('Time')->display(function ($time) {
...
$('#messageModal').on('show.bs.modal', function (event) {
    ...
    modal.find('.modal-body #message-to').val(to);
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <div class="form-group">
            <label for="message-to" class="control-label">To:</label>
            <input type="text" class="form-control" id="message-to">
          </div>
          <div class="form-group">
