...
class ExampleController2 extends Controller
{
    ...
    {
        $grid = new Grid(new Administrator()); //Change Administrator
    ...
    {
        $show = new Show(Administrator::findOrFail($id)); // Change Administrator
    ...
    {
        $form = new Form(new Administrator()); // Administrator
