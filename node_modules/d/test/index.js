    ...
    return {
        ...
        Options: {
            ...
            gs: function (a) {
                ...
                a.deep(d, {
                    configurable: true, enumerable: false, get: gFn, set: sFn,
                    foo: true
                }, "No descriptor");
                ...
                d = t.gs(gFn, {foo: true});
                a.deep(d, {
                    configurable: true, enumerable: false, get: gFn,
                    set: undefined, foo: true
                }, "No descriptor: Just get");

                d = t.gs('e', gFn, sFn, {bar: true});
                a.deep(d, {
                    configurable: false, enumerable: true, get: gFn, set: sFn,
                    bar: true
                }, "Descriptor");
                d = t.gs('e', null, sFn, {bar: true});
                a.deep(d, {
                    configurable: false, enumerable: true, get: undefined,
                    set: sFn, bar: true
                }, "Descriptor: Just set");
                d = t.gs('e', gFn, {bar: true});
                a.deep(d, {
                    configurable: false, enumerable: true, get: gFn,
                    set: undefined, bar: true
                }, "Descriptor: Just get");
            }
        }
    };
