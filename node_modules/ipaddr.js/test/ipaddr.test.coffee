...
module.exports =
  ...
  'converts IPv6 to string correctly': (test) ->
    ...
    test.equal(new ipaddr.IPv6([0x2001, 0xdb8, 0xff, 0xabc, 0xdef, 0x123b, 0x456c,
      0x78d]).toString(), '2001:db8:ff:abc:def:123b:456c:78d')
    test.equal(new ipaddr.IPv6([0x2001, 0xdb8, 0xff, 0xabc, 0, 0x123b, 0x456c,
      0x78d]).toString(), '2001:db8:ff:abc::123b:456c:78d')
    test.equal(new ipaddr.IPv6([0x2001, 0xdb8, 0xff, 0xabc, 0, 0, 0x456c,
      0x78d]).toString(), '2001:db8:ff:abc::456c:78d')
    test.done()
