...
&nbsp;
<span class="cstat-no"
      title="statement not covered">            console.error('COMP_LINE:  %s', process.env.COMP_LINE);</span>
...
<span class="cstat-no"
      title="statement not covered">                return console.log(compls.map(escape).join('\n'));</span>
            });
        });
};
&nbsp;
...
&nbsp;
<span class="cstat-no"
      title="statement not covered">    fs.readFile(path.resolve(__dirname, 'completion.sh'), 'utf8', <span
...
<span class="cstat-no" title="statement not covered">        if(err) <span class="cstat-no"
                                                                           title="statement not covered">return defer.reject(err);</span></span>
...
<span class="cstat-no" title="statement not covered">        process.stdout.write(d, <span class="fstat-no"
                                                                                           title="function not covered">()</span> =&gt; <span
...
<span class="cstat-no" title="statement not covered">        if(err.errno !== constants.EPIPE) <span class="cstat-no"
                                                                                                     title="statement not covered">return defer.reject(err);</span></span>
...
<span class="cstat-no" title="statement not covered">        compls = Object.keys(cmd._cmdsByName);</span>
        ...
        const m = <span class="cstat-no"
                        title="statement not covered">opts.partialWord.match(/^(--\w[\w-_]*)=(.*)$/);</span>
...
<span class="fstat-no" title="function not covered">                (c</span>, o) =&gt; <span class="cstat-no"
                                                                                              title="statement not covered">c.concat(o.map(<span
            class="fstat-no" title="function not covered">v </span>=&gt; <span class="cstat-no"
                                                                               title="statement not covered">(optPrefix || '') + v)</span>))</span>));
&nbsp;
...
<span class="cstat-no" title="statement not covered">    cmd._comp &amp;&amp; (compls = Q.join(compls, Q.when(cmd._comp(opts)), <span
        class="fstat-no" title="function not covered">(c</span>, o) =&gt; <span class="cstat-no"
                                                                                title="statement not covered">c.concat(o))</span>);</span>
&nbsp;
    // TODO: context aware custom completion on cmds, opts and args
    // (can depend on already entered values, especially options)
&nbsp;
<span class="cstat-no" title="statement not covered">    return Q.when(compls, <span class="fstat-no"
                                                                                     title="function not covered">co</span>mplitions =&gt; {</span>
...
<span class="cstat-no" title="statement not covered">        return compls.filter(<span class="fstat-no"
                                                                                        title="function not covered">(c</span>) =&gt; <span
...
<div class='footer quiet pad2 space-top1 center small'>
    Code coverage
    generated by <a href="http://istanbul-js.org/" target="_blank">istanbul</a> at Fri Feb 17 2017 22:25:28 GMT+0300
    (MSK)
</div>
</div>
