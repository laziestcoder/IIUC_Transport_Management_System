                ...
                <select data-id="<?php echo e($BusPoint->routeid); ?>" name="routename" required="true">
                    ...
                    <?php $__currentLoopData = $BusRoutes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $route): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <?php if($route->id == $BusPoint->routeid): ?>
                            <option value="<?php echo e($route->id); ?>" selected><?php echo e($route->routename); ?></option>
                        <?php else: ?>
        ...
        <table class="table table-hover">
            ...
            <?php $__currentLoopData = $BusPoints; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $point): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <tr>    
                    ...
                    <td><a href="/admin/auth/routes/<?php echo e($point->routeid); ?>"><?php echo e($user = DB::table('routes')->where('id', $point->routeid)->first()->routename); ?></a></td>
