            ...
            <table class="table table-hover">
                ...
                foreach ($__currentLoopData as $point): $__env->incrementLoopIndices();
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="/admin/auth/routes/<?php echo e($point->routeid); ?>"><?php echo e($point->route->name); ?></a>
                        </td>
                        <td>
                            <a href="/admin/auth/routes/<?php echo e($point->id); ?>"><?php echo e($point->pointname); ?></a>
                        </td>
                        <td><?php echo e($point->user_id); ?></td>
                        <td><?php echo e($point->created_at); ?></td>
                        <td><a href="/admin/auth/routes/<?php echo e($point->id); ?>/edit"
