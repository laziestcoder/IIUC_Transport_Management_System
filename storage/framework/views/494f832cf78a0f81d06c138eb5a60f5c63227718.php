...
<head>
    ...
    <!-- Theme style -->
    <link rel="stylesheet"
          href="<?php echo e(admin_asset("/vendor/laravel-admin/AdminLTE/dist/css/skins/" . config('admin.skin') . ".min.css")); ?>">

    <?php echo Admin::css(); ?>

    <link rel="stylesheet"
          href="<?php echo e(admin_asset("/vendor/laravel-admin/laravel-admin/laravel-admin.css")); ?>">
    ...
    <link rel="stylesheet"
          href="<?php echo e(admin_asset("/vendor/laravel-admin/bootstrap3-editable/css/bootstrap-editable.css")); ?>">
