<div class="<?php echo e($viewClass['form-group']); ?> <?php echo !$errors->has($errorKey) ? '' : 'has-error'; ?>">
    ...
    <div class="<?php echo e($viewClass['field']); ?>">
        ...
        <textarea name="<?php echo e($name); ?>" class="form-control <?php echo e($class); ?>" rows="<?php echo e($rows); ?>"
                  placeholder="<?php echo e($placeholder); ?>" <?php echo $attributes; ?> ><?php echo e(old($column, $value)); ?></textarea>
