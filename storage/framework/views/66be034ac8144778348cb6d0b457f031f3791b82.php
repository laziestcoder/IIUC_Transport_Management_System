            ...
            <table class="table table-hover">
                ...
                <?php $__currentLoopData = $BusPoints; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $point): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr>    <?php $routename = DB::table('routes')->where('id', $point->routeid)->first(); ?>
                        ...
                        <td><a href="/admin/auth/routes/<?php echo e($point->routeid, false); ?>"><?php echo e($routename->routename, false); ?></a></td>
                        <td><?php echo e(DB::table('admin_users')->where('id', $point->user_id)->first()->name, false); ?></td>
                        <td><?php echo e($point->created_at, false); ?></td>
                        <td><a href="/admin/auth/points/<?php echo e($point->id, false); ?>/edit" class="btn btn-default">Edit</a>
