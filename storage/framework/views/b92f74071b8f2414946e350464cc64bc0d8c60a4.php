                ...
                <div class="mailbox-controls with-border">
                    ...
                    <div class="btn-group">
                        <a href="<?php echo e(route('media-index', ['path' => $url['path'], 'view' => 'table'])); ?>"
                           class="btn btn-default <?php echo e(request('view') == 'table' ? 'active' : ''); ?>"><i
                                    class="fa fa-list"></i></a>
                        <a href="<?php echo e(route('media-index', ['path' => $url['path'], 'view' => 'list'])); ?>"
                           class="btn btn-default <?php echo e(request('view') == 'list' ? 'active' : ''); ?>"><i
                                    class="fa fa-th"></i></a>
                    </div>
                                ...
                                <div class="btn-group btn-group-xs pull-right">
                                    ...
                                    <ul class="dropdown-menu" role="menu">
                                        ...
                                        <li><a href="#" data-toggle="modal" data-target="#urlModal"
                                               data-url="<?php echo e($item['url']); ?>">Url</a></li>
                                    </ul>
                                </div>
                            </span>
                                </div>
