            ...
            <div class="box-body no-padding">
                ...
                <div class="mailbox-controls with-border">
                    ...
                    <a class="btn btn-default btn" data-toggle="modal" data-target="#newFolderModal">
                        <i class="fa fa-folder"></i>&nbsp;&nbsp;<?php echo e(trans('admin.new_folder')); ?>

                    </a>

                    <div class="btn-group">
                        <a href="<?php echo e(route('media-index', ['path' => $url['path'], 'view' => 'table'])); ?>" class="btn btn-default <?php echo e(request('view') == 'table' ? 'active' : ''); ?>"><i class="fa fa-list"></i></a>
                        <a href="<?php echo e(route('media-index', ['path' => $url['path'], 'view' => 'list'])); ?>" class="btn btn-default <?php echo e(request('view') == 'list' ? 'active' : ''); ?>"><i class="fa fa-th"></i></a>
                    </div>
                              ...
                              <?php echo e($item['size']); ?>&nbsp;
                                ...
                                <div class="btn-group btn-group-xs pull-right">
                                    ...
                                    <ul class="dropdown-menu" role="menu">
                                        <li><a href="#" class="file-rename" data-toggle="modal" data-target="#moveModal" data-name="<?php echo e($item['name']); ?>">Rename & Move</a></li>
                                        ...
                                        <?php endif; ?>
                                        <li class="divider"></li>
                                        <li><a href="#" data-toggle="modal" data-target="#urlModal" data-url="<?php echo e($item['url']); ?>">Url</a></li>
                                    </ul>
                                </div>
                            </span>
                            </div>
