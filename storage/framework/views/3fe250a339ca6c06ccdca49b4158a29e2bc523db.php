<?php if($errors->hasBag('exception')): ?>
    ...
    <div class="alert alert-warning alert-dismissable">
        ...
        <h4>
            ...
            <i style="border-bottom: 1px dotted #fff;cursor: pointer;" title="<?php echo e($error->get('type')[0]); ?>"
               ondblclick="var f=this.innerHTML;this.innerHTML=this.title;this.title=f;"><?php echo e(class_basename($error->get('type')[0])); ?></i>
