<?php $__env->startSection('content'); ?>
    ...
    <section class="content">
        ...
        <div class="form-group">
            <?php echo e(Form :: label('title','Select Day')); ?>
            ...
            <select name="day" class="form-control" required="true">
                <?php if( count($days) > 0 ): ?>
                    ...
                    <?php $__currentLoopData = $days; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $day): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($day->id); ?>"><?php echo e($day->dayname); ?></option>
            ...
            <select name="time" class="form-control" required="true">
                <?php if( count($times) > 0 ): ?>
                    ...
                    <?php $__currentLoopData = $times; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $time): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($time->id); ?>"><?php echo e(Carbon\Carbon::parse($time->time)->format('g:i A')); ?></option>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                <?php else: ?>
                    <option selected="true">No Time Found</option>
                <?php endif; ?>
        ...
        <fieldset>
            ...
            <div class="form-group">
                ...
                <?php echo e(Form :: checkbox('male' , 1, ['class' => 'checkbox form-control',])); ?>
                ...
                <?php echo e(Form :: checkbox('female' , 1, ['class' => 'checkbox form-control',])); ?>

            </div>
        </fieldset>

        <div class="form-group">
            <?php echo e(Form :: label('title','Select a route')); ?>
